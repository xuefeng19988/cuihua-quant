...
export const constantRoutes = [
  ...
  { path: '/health-check', component: Layout, children: [{ path: '', name: 'HealthCheck', component: () => import('@/views/health-check/index'), meta: { title: '健康检查', icon: 'el-icon-success' } }] },
  { path: '/error-handler', component: Layout, children: [{ path: '', name: 'ErrorHandler', component: () => import('@/views/error-handler/index'), meta: { title: '错误处理', icon: 'el-icon-warning' } }] },
  { path: '/test-runner', component: Layout, children: [{ path: '', name: 'TestRunner', component: () => import('@/views/test-runner/index'), meta: { title: '测试运行器', icon: 'el-icon-circle-check' } }] },
  { path: '/security-config', component: Layout, children: [{ path: '', name: 'SecurityConfig', component: () => import('@/views/security-config/index'), meta: { title: '安全配置', icon: 'el-icon-lock' } }] },
  { path: '/log-rotator', component: Layout, children: [{ path: '', name: 'LogRotator', component: () => import('@/views/log-rotator/index'), meta: { title: '日志轮转', icon: 'el-icon-refresh' } }] },
  { path: '/db-backup', component: Layout, children: [{ path: '', name: 'DBBackup', component: () => import('@/views/db-backup/index'), meta: { title: '数据库备份', icon: 'el-icon-files' } }] },
  { path: '/monitor-alert', component: Layout, children: [{ path: '', name: 'MonitorAlert', component: () => import('@/views/monitor-alert/index'), meta: { title: '监控告警', icon: 'el-icon-bell' } }] },
  { path: '/shortcut-config', component: Layout, children: [{ path: '', name: 'ShortcutConfig', component: () => import('@/views/shortcut-config/index'), meta: { title: '快捷键配置', icon: 'el-icon-key' } }] },
  { path: '/data-wizard', component: Layout, children: [{ path: '', name: 'DataWizard', component: () => import('@/views/data-wizard/index'), meta: { title: '数据导入向导', icon: 'el-icon-magic-stick' } }] },
  { path: '/print-optimizer', component: Layout, children: [{ path: '', name: 'PrintOptimizer', component: () => import('@/views/print-optimizer/index'), meta: { title: '打印优化', icon: 'el-icon-printer' } }] },
  { path: '/accessibility', component: Layout, children: [{ path: '', name: 'Accessibility', component: () => import('@/views/accessibility/index'), meta: { title: '无障碍访问', icon: 'el-icon-view' } }] },
  { path: '/llm-integration', component: Layout, children: [{ path: '', name: 'LLMIntegration', component: () => import('@/views/llm-integration/index'), meta: { title: 'LLM集成', icon: 'el-icon-cpu' } }] },
  { path: '/image-recognition', component: Layout, children: [{ path: '', name: 'ImageRecognition', component: () => import('@/views/image-recognition/index'), meta: { title: '图像识别', icon: 'el-icon-picture' } }] },
  { path: '/openapi-doc', component: Layout, children: [{ path: '', name: 'OpenAPIDoc', component: () => import('@/views/openapi-doc/index'), meta: { title: 'OpenAPI文档', icon: 'el-icon-document' } }] },
  { path: '/webhook-manager', component: Layout, children: [{ path: '', name: 'WebhookManager', component: () => import('@/views/webhook-manager/index'), meta: { title: 'Webhook管理', icon: 'el-icon-link' } }] },
  { path: '/plugin-manager', component: Layout, children: [{ path: '', name: 'PluginManager', component: () => import('@/views/plugin-manager/index'), meta: { title: '插件管理', icon: 'el-icon-setting' } }] },
  { path: '/sdk-docs', component: Layout, children: [{ path: '', name: 'SDKDocs', component: () => import('@/views/sdk-docs/index'), meta: { title: 'SDK文档', icon: 'el-icon-notebook-2' } }] },
  { path: '/data-marketplace', component: Layout, children: [{ path: '', name: 'DataMarketplace', component: () => import('@/views/data-marketplace/index'), meta: { title: '数据市场', icon: 'el-icon-shopping-cart-2' } }] },
