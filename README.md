...
### 📈 策略系统
- **20+ 内置策略**: SMA 交叉、多因子、动量、均值回归、期权、新闻交易、配对交易、波动率交易、统计套利、行业轮动等
...
- **15+ 高级因子**: 质量/价值/成长/情绪/微观结构/流动性/动量反转/波动率风险溢价
...
- **智能仓位管理**: Kelly 公式、最优 f、ATR 动态仓位、自适应仓位
- **多资产支持**: 股票/债券/加密货币/商品
- **智能订单路由**: 多经纪商最佳执行
